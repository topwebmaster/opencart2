...
$_['text_yes'] = 'Да';
$_['text_no'] = 'Нет';
$_['text_enabled'] = 'Активно';
$_['text_disabled'] = 'Неактивно';
$_['text_none'] = ' --- Нет --- ';
$_['text_select'] = ' --- Пожалуйста выберите --- ';
$_['text_select_all'] = 'Выбрать всё';
$_['text_unselect_all'] = 'Убрать всё';
$_['text_all_zones'] = 'Все зоны';
$_['text_default'] = ' <b>(По умолчанию)</b>';
$_['text_close'] = 'Закрыть';
$_['text_pagination'] = 'Показывaть %d to %d of %d (%d Страницы)';
$_['text_loading'] = 'Загружается...';
$_['text_no_results'] = 'Нет результатов!';
$_['text_confirm'] = 'Вы уверены?';
$_['text_home'] = 'Главная';
$_['text_confirm'] = 'Удалить/Демонтировать невозможно отменить be undone! Are you sure you want to do this?';

// Button
$_['button_insert'] = 'Добавить новый';
$_['button_delete'] = 'Удалить';
$_['button_save'] = 'Сохранить';
$_['button_cancel'] = 'Удалить';
$_['button_cancel_recurring'] = 'Отменить рекурсивные платежи';
$_['button_continue'] = 'Продолжить';
$_['button_clear'] = 'Очистить';
$_['button_close'] = 'Закрыть';
$_['button_enable'] = 'Активировать';
